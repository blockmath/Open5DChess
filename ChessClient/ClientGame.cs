...
namespace ChessClient
{
    public class ClientGame : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            GameStateRenderer.gameState.timer = new Timer(300_000_000, 5_000_000);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(spriteFont, "Submit Moves", ButtonSubmitRect.Center.ToVector2() - spriteFont.MeasureString("Submit Moves") / 2 + new Vector2(0, -5), Color.Black);
            spriteBatch.DrawString(spriteFont, "Undo Move", ButtonUndoRect.Center.ToVector2() - spriteFont.MeasureString("Undo Move") / 2 + new Vector2(0, -5), Color.Black);
